...
describe('Scope', () => {
  ...
  describe('digest', () => {
    ...
    it('executes $evaluated\'ed function and returns result', () => {
      scope.aValue = 42;

      const result = scope.$evaluated((scope) => {
        return scope.aValue;
      });
    ...
    it('passes the second $evaluated argument straight through', () => {
      scope.aValue = 42;

      const result = scope.$evaluated((scope, arg) => {
    ...
    it('executs $apply\'ed function and starts the digest', () => {
